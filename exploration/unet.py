"""
This is a script to implement U-net  for neuron identification
Reference for the Unet Model
...
class UNet:
   ...
   :input_shape: tuple (rows, columns, channels)
    ...
    def train(input_shape, train, mask):
    '''
        This function is used to train the Unet model.
        Args:
    ...
    '''
        ...
        print('Fitting model...')
        model.fit(train, mask, batch_size=1, epochs=60, verbose=1, shuffle=True, callbacks=[es])



train((640,640),,trainMaskPath)
